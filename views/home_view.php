...
<img src="https://picsum.photos/seed/picsum/1900/850" class="absolute top-0 left-0 min-h-full ob" alt="">
  <div class="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
    <div class="col-span-6">
      <span class="uppercase text-white text-xs font-bold mb-2 block">wiki</span>
      <h1 class="text-white font-extrabold text-5xl mb-8">Knowledge at Your Fingertips: Wiki Edition</h1>
      <p class="text-stone-100 text-base">
      Navigating the Landscape of Wisdom, unlocking the Secrets of the World, Embark on a Knowledge Odyssey with Wiki
      </p>
