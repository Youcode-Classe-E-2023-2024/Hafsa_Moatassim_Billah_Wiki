...
<style>
  ...
  <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
    ...
    <textarea class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" spellcheck="false" name="content" placeholder="Describe everything about this post here"></textarea>

<div class="m-3">
        <select class="z-2 mt-1 w-full rounded bg-green-100 ring-1 ring-gray-300"  name="tags" required>
...
<div class="m-3">
    ...
    <main class="items-center justify-center bg-gray-100 font-sans">
    ...
    <div class="buttons flex mt-5">
      ...
      <div class="btn border border-indigo-500 p-1 px-4 font-semibold cursor-pointer text-gray-200 ml-2 bg-blue-700">Post</div>
    </div>
  </div>